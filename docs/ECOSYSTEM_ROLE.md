# Ecosystem Role
    ...
    Repository: `OMNIA-SECURITY`

    Last hardening pass: `2026-05-21T14:03:44Z`

    ## Role

    Bounded security-domain structural diagnostics adapter.
    ...
    Measures structural behavior in security-relevant traces; not a scanner, exploit tool, or decision engine.
